...
## 2. <span style="color: #7F52FF;">Solve (530 Problems)</span>

<li><u style="text-decoration-color: #7F52FF;">Solve problems</u><span style="color: #7F52FF;">.</span></li>

|                                    Name                                     | Problems / Mini Projects |
|:---------------------------------------------------------------------------:|:------------------------:|
|     <a style="color: #7F52FF;" href="https://coderhub.sa">CoderHub</a>      |       157 Problems       |
...
### <span>1. <a style="color: #7F52FF;" href="https://coderhub.sa">CoderHub</a> (157 Problems, (83 Easy, 52 Medium, 22 Hard)) 🟩</span> (<a style="color: #7F52FF;" href="https://profile.satr.codes/M4MD24/public/overview">@M4MD24</a>)

1. <a style="color: #7F52FF;" href="https://coderhub.sa/challenges">Challenges</a> (149 Problems)
    1. <a style="color: #7F52FF;" href="https://coderhub.sa/challenges?solvedFilter=ALL&level=EASY">Easy</a> (79 Problems)
    2. <a style="color: #7F52FF;" href="https://coderhub.sa/challenges?solvedFilter=ALL&level=MEDIUM">Medium</a> (52 Problems)
    3. <a style="color: #7F52FF;" href="https://coderhub.sa/challenges?solvedFilter=ALL&level=HARD">Hard</a> (18 Problems)
...
1. <span style="color: #7F52FF;">Exercise</span> (101 Problems)
    1. <a style="color: #7F52FF;" href="https://www.w3resource.com/kotlin-exercises/index.php">Kotlin</a> (101 Problems)
        ...
        7. <a style="color: #7F52FF;" href="https://www.w3resource.com/kotlin-exercises/oop/index.php">OOP (Object Oriented Programming)</a> (7 Problems)
