package _1_learn._1_4_data_structures._1_4_7_hash_set

fun main() {
    val numbers: HashSet<Int> = hashSetOf(1, 2, 3, 4, 5, 5, 5)
    ...
    // Add elements
    numbers.add(6)
    println("Adding 6: $numbers")

    // Remove element
    numbers.remove(3)
    println("Removing 3: $numbers")
